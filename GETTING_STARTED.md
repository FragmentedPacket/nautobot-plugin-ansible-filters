...
#14 naming to docker.io/ansible-filters/nautobot:latest-py3.7 done
```
...
Creating network "ansible_filters_default" with the default driver
Creating volume "ansible_filters_postgres_data" with default driver
Creating ansible_filters_redis_1 ... 
Creating ansible_filters_docs_1  ... 
Creating ansible_filters_postgres_1 ... 
Creating ansible_filters_postgres_1 ... done
Creating ansible_filters_redis_1    ... done
Creating ansible_filters_nautobot_1 ... 
Creating ansible_filters_docs_1     ... done
Creating ansible_filters_nautobot_1 ... done
Creating ansible_filters_worker_1   ... 
Creating ansible_filters_worker_1   ... done
...
ee90fbfabd77   ansible-filters/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               ansible_filters_worker_1
b8adb781d013   ansible-filters/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   ansible_filters_nautobot_1
d64ebd60675d   ansible-filters/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   ansible_filters_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   ansible_filters_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   ansible_filters_redis_1
```
...
Stopping ansible_filters_worker_1   ... 
Stopping ansible_filters_nautobot_1 ... 
Stopping ansible_filters_docs_1     ... 
Stopping ansible_filters_redis_1    ... 
Stopping ansible_filters_postgres_1 ... 
Stopping ansible_filters_worker_1   ... done
Stopping ansible_filters_nautobot_1 ... done
Stopping ansible_filters_postgres_1 ... done
Stopping ansible_filters_redis_1    ... done
Stopping ansible_filters_docs_1     ... done
Removing ansible_filters_worker_1   ... 
Removing ansible_filters_nautobot_1 ... 
Removing ansible_filters_docs_1     ... 
Removing ansible_filters_redis_1    ... 
Removing ansible_filters_postgres_1 ... 
Removing ansible_filters_postgres_1 ... done
Removing ansible_filters_docs_1     ... done
Removing ansible_filters_worker_1   ... done
Removing ansible_filters_redis_1    ... done
Removing ansible_filters_nautobot_1 ... done
Removing network ansible_filters_default
```
...
So for example, our plugin is named `ansible-filters`, the command would most likely be `docker logs ansible_filters_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("ansible_filters")
namespace.configure(
    {
        "ansible_filters": {
            ...
...
Or set the `INVOKE_ANSIBLE_FILTERS_PYTHON_VER` variable
...
Or set the `INVOKE_ANSIBLE_FILTERS_NAUTOBOT_VER` variable
